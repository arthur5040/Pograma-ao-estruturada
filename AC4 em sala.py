...
def ler_notas():
    ...
    """
    ap1 = float(input("informe nota da ac1"))
    ap2 = float(input("informe nota da ac2"))
    asub= float(input("informe nota da as"))
    ac= float(input("informe nota da as"))
...
def calcular_media(nota1, nota2, ac):
    ...
    """
    return round(nota1 + nota2) * 0.4 + 0.2 * ac
